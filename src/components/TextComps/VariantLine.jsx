...
export default function VariantLine({ marker, textcard, icon_1, icon_2}) {
  ...
  const theme = useTheme();
    ...
    return (
      ...
      <Grid container sx={{mb:2, pr:2, pl:2, display: 'flex', justifyContent: 'flex-start', alignItems: 'center',  bgcolor: 'grey.C100', borderRadius: '10px'}}> 
          ...
          <Grid item xs={7}  sx={{display: 'flex', justifyContent: 'flex-start', alignItems: 'center',}}>   <TextCard textcard={textcard} /> </Grid> 
